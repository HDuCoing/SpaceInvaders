...
public class SpaceInvaders extends JFrame implements Commons {
	...
	private static final String INITIAL_MESSAGE = "Help us Captain Awesome! \n!!<br>The aliens are trying to invade our planet.<br><br><br>Your mission:<br><br>Kill all invading aliens before they manage to invade planet Earth\n.<br>And preferably don't die in battle!<br><br><br>GOOD LUCK!!!".formatted();
	/*
	 * HELP
	 */
	private static final String HELP_TOP_MESSAGE = "HELP";
	private static final String HELP_MESSAGE = "CONTROLS: <br><br>Left Movement: <br>Keyboard Left Arrow<br><br>Right Movement: <br>Keyboared Right Arrow<br><br>Shoot: <br>Space Bar".formatted();
